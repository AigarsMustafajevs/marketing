...
def getClient():
    client = tweepy.Client(
        bearer_token=config('bearer_token_RF'),
        consumer_key=config('consumer_key_RF'),
        consumer_secret=config('consumer_secret_RF'),
        access_token=config('access_token_RF'),
        access_token_secret=config('access_token_secret_RF'))
    return client
