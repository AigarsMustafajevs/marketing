...
def getClient():
    client = tweepy.Client(
        bearer_token=config('bearer_token_AM'),
        consumer_key=config('consumer_key_AM'),
        consumer_secret=config('consumer_secret_AM'),
        access_token=config('access_token_AM'),
        access_token_secret=config('access_token_secret_AM'))
    return client
