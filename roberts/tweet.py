...
auth = tweepy.OAuthHandler(config('consumer_key_RM'), config(
    'consumer_secret_RM'))  # KYLE FOR TESTING
auth.set_access_token(config('access_token_RM'), config(
    'access_token_secret_RM'))  # KYLE FOR TESTING
...
if action == 'Meme':
    ...
    os.chdir("/Users/aigars/Desktop/rok-finance/marketing/roberts/data/media/memes")
    tweet_photo = random.choice(os.listdir(
        "/Users/aigars/Desktop/rok-finance/marketing/roberts/data/media/memes"))
